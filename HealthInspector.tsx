    ...
    <div className="max-w-3xl mx-auto px-6 py-6">
      ...
      {view === 'summary' && (
        <div className="mt-5 space-y-5">
          ...
          <p className="text-[11px] text-rsl-navy/40 text-center pt-1">
            PDF and email report generation for SOHC is coming in a future session — for now, review and
            edit any flagged items above; changes autosave the same as everywhere else.
          </p>
        </div>
      )}
    </div>
